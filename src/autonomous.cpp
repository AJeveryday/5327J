...
void appcSquare()
{
    ...
    pathfollowing::AdaptivePurePursuit controller(
        std::make_unique<IterativePosPIDController>(0.2, 0.0, 60.0, 0.0, std::make_unique<AverageFilter<5>>()),
        std::make_unique<IterativePosPIDController>(0.6, 0.0, 20.0, 0.0, std::make_unique<AverageFilter<5>>()),
